...
<script>
	...
	function fnRemoveUpload(){
		if(confirm('게시글을 삭제하면 모든 첨부 파일이 함께 삭제됩니다. 그래도 삭제하시겠습니까?') == true){
			return;
		}else{
	...
	function fnEdit(){
		...
		frm.prop('action', '${contextPath}/update/edit.do');
		frm.submit();
	}
...
<body>
	...
	<div>
		...
		<form id="frm" method="post">
			<input type="hidden" name="editeNo" value="${upload.uploadNo}">
