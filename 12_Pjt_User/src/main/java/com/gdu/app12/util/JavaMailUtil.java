...
public class JavaMailUtil {
	...
	public void sendJavaMail(String to, String title, String content) {
		try {
			...
			properties.put("mail.smtp.starttls.enable", env.getProperty("spring.mail.properties.mail.smtp.mail.smtp.starttls.enable"));
			// 이메일 보내는 계정 정보를 javax.mail.Session에 저장한다 
			...
			//이메일 만들기
			message.setFrom(new PasswordAuthentication(env.getProperty("spring.mail.username"), "사이트관리자"));
